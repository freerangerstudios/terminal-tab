...
const COMMANDS = {
  ...
  o: { func: joinWriter(openLink, textWriter), help: "usage: o <path>" },
  touch: {
  ...
  cls: { func: cls, help: "usage: cls" },
  clear: { func: cls, help: "usage: clear" },
  ...
  move: {
    func: joinWriter(mv, textWriter),
    help: "usage: move <source path> <target path>",
  },
  edit: {
